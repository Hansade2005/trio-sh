...
export const TURBO_EDITS_PROMO_MESSAGE: MessageConfig = {
  spans: [
    ...
    { type: "link", content: " Get Trio Pro", url: "https://triobuilder.cc/pro#ai" },
...
export const SMART_CONTEXT_PROMO_MESSAGE: MessageConfig = {
  spans: [
    ...
    {
      type: "link",
      content: "Trio Smart Context",
      url: "https://triobuilder.cc/docs/guides/ai-models/pro-modes#smart-context",
    },
  ],
};
...
export const REDDIT_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      ...
      url: "https://www.reddit.com/r/dyadbuilders/", // No Trio subreddit yet, keep as is or update if available
    },
  ],
};
...
export const DEBUGGING_TIPS_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      ...
      url: "https://www.triobuilder.cc/docs/guides/debugging",
    },
  ],
};

// Advanced tip: Customize your AI rules https://www.triobuilder.cc/docs/guides/ai-rules
export const AI_RULES_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      type: "link",
      content: "AI rules",
      url: "https://www.triobuilder.cc/docs/guides/ai-rules",
    },
  ],
};
...
// Want to know what's next? Checkout our roadmap https://www.triobuilder.cc/docs/roadmap
export const ROADMAP_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      type: "link",
      content: "roadmap",
      url: "https://www.triobuilder.cc/docs/roadmap",
    },
  ],
};

// Like Trio? Star it on GitHub https://github.com/trio-sh/trio/
export const GITHUB_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      type: "link",
      content: "GitHub",
      url: "https://github.com/trio-sh/trio",
    },
  ],
};
