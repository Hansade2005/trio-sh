  ...
  return (
    <Popover>
      <Tooltip>
        ...
        <TooltipContent>Configure Trio Pro settings</TooltipContent>
      </Tooltip>
        ...
        <div className="space-y-4">
          <div className="space-y-1">
            <h4 className="font-medium flex items-center gap-1.5">
              <Sparkles className="h-4 w-4 text-primary" />
              <span className="text-primary font-medium">Trio Pro</span>
            </h4>
          ...
          <div className="flex flex-col gap-5">
            <SelectorRow
              id="pro-enabled"
              label="Enable Trio Pro"
              description="Use Trio Pro AI credits"
              tooltip="Uses Trio Pro AI credits for the main AI model and Pro modes."
